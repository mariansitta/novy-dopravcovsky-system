...
@section('body')
    ...
    @section('content')
        ...
        @include('web._partials._modal_docs')
@endsection
            ...
            let t = $('#datatable').DataTable({
                ...
                "columns" : [
                    ...
                    { "data": null, render: function(data) {
                            ...
                            let result = " <td>";
                            let upload_route = "{{ route('transports.bill', ':id') }}".replace(':id', data.trans_id);
                            ...
                            result += (bill_html !== null) ? "</td>" : upload + "</td>";
                            return result;
                        }
                    },
                    { "data": null, render: function(data) {
                            ...
                            let result = " <td>";
                            let upload_route = "{{ route('transports.docs', ':id') }}".replace(':id', data.trans_id);
                            let upload = " <a class=\"btn btn-warning waves-effect waves-light action-button\" title=\"{{ trans('texts.Upload documents') }}\" href=\"" + upload_route + "\">\n" +
                                "                            <i class=\"fas fa-folder-open action-icon\"></i>\n" +
                                "                        </a>\n";

                            result += (document_html !== null) ? document_html : "";
                            result += (document_html !== null) ? "</td>" : upload + "</td>";
                            return result;
                        }
                    },
                    { "data": null, render: function(data) {
